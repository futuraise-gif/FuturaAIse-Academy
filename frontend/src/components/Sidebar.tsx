...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const navItems = [
    ...
    { path: '/admin/student-registration', label: 'Student Registration', icon: '📋', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
    { path: '/admin/crm', label: 'CRM Dashboard', icon: '📊', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
    { path: '/admin/crm/leads', label: 'Lead Management', icon: '🎯', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
    { path: '/admin/crm/invoices', label: 'Invoices', icon: '📄', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
    { path: '/admin/crm/payments', label: 'Payments', icon: '💰', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
    { path: '/admin/crm/tasks', label: 'Tasks & Follow-ups', icon: '✅', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
    { path: '/admin/beta-testing', label: 'Beta Testing', icon: '🧪', roles: [UserRole.ADMIN, UserRole.SUPER_ADMIN] },
